...
if (!empty($post_array['add'])) {
    ...
    $add = FALSE;
    // Save event types
    $result = $product->saveMobiel($post_array);
    if ($result) {
        // Save was succesfull
        $add = TRUE;
    } else {
...
<section class="section section_menu section_border_bottom">
    ...
    <h2>Abonnementen</h2>
    <a class="btn btn-primary" href="telefoons.php?pagename=Overzicht#overzicht">Overzicht</a>
    <a class="btn btn-primary" href="telefoons.php?pagename=Product%20Aanmaken#aanmaken">Product Aanmaken</a>
    <?php
    if (isset($add)) {
    ...
    $filepath = 'http://localhost/OpdrachtOOPHP/telefoons.php?pagename=Overzicht';
    ...
    <?php } ?>
        ...
        <?php } else {
            $product_list = $product->getMobielList();
                ...
                ?>
                    ...
                    <?php } else { ?>
                        <?php if ($action !== 'update') {
                            ...
                            ?>
                            <td width="10"><?= $product_obj->getMobielId(); ?></td>
                            <td width="180"><?=$product_obj->getMobiel(); ?></td>
                            <td width="200"><?=$product_obj->getMobielAfbeelding(); ?></td>
        ...
        if ($action !== 'update') {
            ...
            <div class="row" id="aanmaken">
                <div class="col-md-12">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="mobiel">Mobiel <span class='red'>*</span></label>
                            <input type="text" class="form-control" id="mobiel" name="mobiel" placeholder=""
                                   required>
                            <div class="valid-feedback">
                            Mobiel is ingevuld!
                            </div>
                            <div class="invalid-feedback">
                            Mobiel is niet ingevuld!
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="mobiel_img">Afbeelding link <span class='red'>*</span></label>
                            <input type="text" class="form-control" id="mobiel_img" name="mobiel_img"
